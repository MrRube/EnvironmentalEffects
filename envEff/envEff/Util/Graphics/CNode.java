...
public class CNode{
	...
	public CNode(float x, float z, float theta){
		posX = x;	
		posZ = z;
		angle = theta;
	}
	
	public CNode(float x,float y,  float z, float theta){
		this(x, z, theta);
		posY = y;
	}
	
	public CNode(float x, float y, float z, float theta, int alph){
		this(x,y,z, theta);
		alpha = alph;
	}
	public CNode(float x,float  y, float z, float theta, EnumColors c){
		this(x,y,z,theta);
		color.setColor(c);
	}
